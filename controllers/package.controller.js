...
//   try {
//     const packages = await Packgae.find();
//     if (!packages) {
...
//   try {
//     const { id } = req.params;
//     const packages = await Packgae.findById(id);
...
//     // Mapping nested objects from flat form-data keys
//     const title = {
//       en: body["title.en"],
//       kh: body["title.kh"],
//       ch: body["title.ch"],
...
//       kh: body["description.kh"] || "",
//       ch: body["description.ch"] || "",
//     };

//     if (!title.en || !title.kh) {
//       return res.status(400).json({ success: false, message: "Titles are required" });
//     }

//     const newPackage = await Packgae.create({
//       title,
//       description,
//       image: file ? file.path : null,
//     });

//     res.status(201).json({ success: true, message: "Created successfully", data: newPackage });
//   } catch (error) {
...
//   try {
//     const { id } = req.params;
//     const existing = await Packgae.findById(id);

//     if (!existing) {
//       return res.status(404).json({ success: false, message: "Package not found" });
//     }

//     // Use existing data as fallback to prevent overwriting with null/undefined
//     const updateData = {
//       title: {
//         en: req.body["title.en"] || existing.title.en,
//         kh: req.body["title.kh"] || existing.title.kh,
//         ch: req.body["title.ch"] || existing.title.ch,
//       },
//       description: {
//         en: req.body["description.en"] || existing.description?.en || "",
//         kh: req.body["description.kh"] || existing.description?.kh || "",
//         ch: req.body["description.ch"] || existing.description?.ch || "",
//       },
//     };
...
//     const updated = await Packgae.findByIdAndUpdate(
//       id,
//       { $set: updateData },
//       { new: true, runValidators: true }
//     );
...
//   try {
//     const { id } = req.params;
//     const packages = await Packgae.findByIdAndDelete(id);
//     if (!packages) {
//       return res.status(404).json({
//         success: false,
//         message: "Package not found",
